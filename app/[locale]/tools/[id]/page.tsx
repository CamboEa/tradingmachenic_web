...
export default async function ToolDetailPage({
 ...
 {/* Image */}
 <div className="w-full overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 lg:w-105 lg:shrink-0">
 {tool.image_url ? (
 // eslint-disable-next-line @next/next/no-img-element
 ...
 if (!desc) return null;
 return (
 <section className="rounded-[1.5rem] border border-white/80 bg-white/88 p-8 backdrop-blur">
 ...
 <section
 key={block.key}
 className={`rounded-[1.5rem] border bg-white/88 p-8 backdrop-blur ${
 block.caution
 ...
 <section className="rounded-[1.5rem] border border-slate-200 bg-white/88 p-8 backdrop-blur">
 ...
 <div className="rounded-[1.5rem] border border-white/80 bg-white/88 p-6 backdrop-blur">
