...
function ToolCard({ tool, locale }: { tool: Tool; locale: Locale }) {
 ...
 return (
 <Link href={`/${locale}/tools/${tool.id}`} className="group flex flex-col overflow-hidden rounded-[1.5rem] border border-white/80 bg-white/88 backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-sky-200" aria-label={tool.name}>
...
export default async function ToolsPage({
 ...
 <p className="text-2xl font-bold text-[#1e293b]">{t.comingSoon}</p>
