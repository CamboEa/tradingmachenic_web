...
function StatCard({
 ...
 return (
 <div
 className={`rounded-2xl border border-white/80 border-l-4 bg-white/88 p-5 backdrop-blur transition hover:-translate-y-0.5 ${ring}`}
 >
...
export default async function AdminDashboard() {
 ...
 return (
 <div>
 <div className="mb-8 rounded-[2rem] border border-white/80 bg-white/78 p-6 backdrop-blur">
 ...
 key={a.href}
 href={a.href}
 className={`rounded-xl px-5 py-2.5 text-sm font-semibold transition hover:-translate-y-0.5 ${a.color}`}
 >
 {a.label}
 </Link>
 ))}
 ...
 <div className="overflow-hidden rounded-2xl border border-white/80 bg-white/88 backdrop-blur">
 ...
 <div
 key={phase.id}
 className="rounded-2xl border border-white/80 bg-white/88 p-5 backdrop-blur"
 >
