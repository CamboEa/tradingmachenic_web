    ...
    <div>
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-lg border border-slate-200 px-4 py-2.5 text-sm font-semibold text-[#1e293b] shadow-sm transition hover:bg-slate-50"
          >
            + Add phase
          </Link>
        </div>
      ...
      {sorted.length === 0 ? (
        <div className="rounded-xl border border-slate-200 bg-white p-10 text-center shadow-sm">
          ...
          <Link
            href="/admin/program/phase/new"
            className="mt-6 inline-flex rounded-lg bg-[#0ea5e9] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-600"
          >
            + Add phase
          </Link>
        </div>
          ...
          {sorted.map((phase) => {
            ...
            return (
              <section key={phase.id}>
                <div
                  className={`mb-4 flex flex-col gap-3 rounded-xl border border-slate-200 border-l-4 bg-white px-5 py-4 shadow-sm sm:flex-row sm:items-center sm:justify-between ${accentBorder}`}
                >
                  <div>
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Link
                      ...
                      className="rounded-md bg-[#0ea5e9] px-3 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-sky-600"
                    >
                      + Add module
                    </Link>
                    <Link
