  ...
  return createPortal(
    ...
    >
      <button
        ...
        className="absolute inset-0 bg-[#1e293b]/45 backdrop-blur-[2px] transition-opacity"
      ...
      <div
        ...
        className="relative w-full max-w-md overflow-hidden rounded-2xl border border-slate-200/90 bg-[#f8fafc] shadow-[0_24px_60px_-20px_rgba(15,23,42,0.35)]"
      >
        <div className="border-b border-slate-200/80 bg-white px-6 py-5">
          <div className="flex gap-4">
            ...
            <div className="min-w-0 pt-0.5">
              <h2 id={titleId} className="text-lg font-bold tracking-tight text-[#1e293b]">
                {title}
              </h2>
        ...
        <div className="flex flex-col-reverse gap-2 px-6 py-4 sm:flex-row sm:justify-end">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={loading}
            className={`rounded-lg px-4 py-2.5 text-sm font-semibold shadow-sm transition focus-visible:outline-none focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-60 ${confirmClass}`}
          >
