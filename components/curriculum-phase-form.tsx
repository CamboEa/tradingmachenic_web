      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm outline-none focus:border-[#0ea5e9] focus:bg-white read-only:cursor-default read-only:opacity-80"
          />
        ...
        <div>
          ...
          <select
            ...
            className="w-full max-w-xs rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm outline-none focus:border-[#0ea5e9] focus:bg-white"
          >
