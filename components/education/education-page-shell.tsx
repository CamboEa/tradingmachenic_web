...
export const EDUCATION_HUB_BACKGROUND = "/background_image/educaiton_background.png";
...
export function EducationPageShell({
  ...
  return (
    <div className={`relative min-h-screen ${backgroundImage ? "bg-teal" : "bg-background"}`}>
      {backgroundImage ? (
        <>
          <Image
            src={backgroundImage}
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 bg-gradient-to-b from-teal/55 via-teal/25 to-teal/70"
          />
        </>
      ) : (
        <>
