      ...
      <svg viewBox="0 0 64 64" fill="none" className="h-16 w-16 text-slate-300" aria-hidden>
        {type === "indicator" ? (
          <>
            ...
            <path d="M14 24c7 5 12 6 18 1s10-8 18-2" stroke="#22332E" strokeWidth="4" strokeLinecap="round" />
          </>
        ) : (
          <>
            <rect x="15" y="18" width="34" height="28" rx="8" stroke="currentColor" strokeWidth="4" />
            <path d="M24 30h.01M40 30h.01M27 39h10" stroke="#22332E" strokeWidth="4" strokeLinecap="round" />
